...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: -7WeEFfSyDsa/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__rbQaK)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column___3AkKq)}>
            <h5
