...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: xFwwfgIWOiRe/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fs02A)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__h25DY)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__c04Q)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__oNbcb)}>
          <div className={classNames(projectcss.all, sty.freeBox___74Zo0)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__yYOje)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox___9X9Fi)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__dyUo4)}
          />
        </div>
      </Stack__>
    </div>
