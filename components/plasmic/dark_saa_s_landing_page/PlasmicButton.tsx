...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dLCYJ7aANpqB/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__fpo6C)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___4FV9F)}
                role={"img"}
              />
            ),
